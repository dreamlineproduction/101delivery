...
?>
<div class="accordion option-collapse" id="collapseSettings">
    <div class="accordion-item d-grid">
        <button
            class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>"
            type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseColors"
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="collapse show" id="collapse-background">
                            <input type="text" class="form-control qrcolorpicker colorpickerback rounded-0"
                                value="<?php echo $stringbackcolor; ?>" name="backcolor">
                        </div>
                    </div>
                </div>
                <div class="custom-control custom-switch mt-2">
                    <input type="checkbox" class="custom-control-input collapse-control-reversed" id="trans-bg"
                        name="transparent" data-bs-target="#collapse-background" data-target="#collapse-background">
                    <label class="custom-control-label"
                        for="trans-bg"><?php echo qrcdr()->getString('transparent_background'); ?></label>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control qrcolorpicker rounded-0"
                            value="<?php echo $stringfrontcolor; ?>" name="frontcolor">

                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input collapse-control" id="gradient-bg"
                                    data-bs-target="#collapse-gradient" data-target="#collapse-gradient"
                                    name="gradient">
                                <label class="custom-control-label"
                                    for="gradient-bg"><?php echo qrcdr()->getString('gradient'); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="collapse" id="collapse-gradient">
                            ...
                            <input type="text" class="form-control qrcolorpicker qrcolorpicker_bg rounded-0"
                                value="#8900D5" name="gradient_color">
                            <div class="form-group">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="radial-gradient"
                                        name="radial">
                                    <label class="custom-control-label"
                                        for="radial-gradient"><?php echo qrcdr()->getString('radial'); ?></label>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="accordion-item d-grid">
        <button
            class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>"
            type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseStyle"
            ...
            <div class="col-12 mb-2">
                <div class="row collapse collapse-markers-bg">
                    <div class="col-sm-6 mt-2">
                        ...
                        <div class="input-group rounded-0">
                            <span class="input-group-text rounded-0 border-0 text-dark"><svg width="1em" height="1em"
                                    viewBox="0 0 14 14" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M0,0v14h14V0H0z M12,12H2V2h10V12z"></path>
                                </svg></span>
                            <input type="text" class="qrcolorpicker form-control rounded-0"
                ...
                <div class="row">
                    <div class="col-12 mt-2">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input collapse-control" id="markers-bg"
                                data-bs-target=".collapse-markers-bg" data-target=".collapse-markers-bg"
                                name="markers_color">
                            <label class="custom-control-label"
                                for="markers-bg"><?php echo qrcdr()->getString('custom_markers_colors'); ?></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse collapse-markers-bg">
                        ...
                        <div class="col-12 mt-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input collapse-control"
                                    id="different-markers-bg" data-bs-target="#collapse-different-markers-bg"
                                    data-target="#collapse-different-markers-bg" name="different_markers_color">
                                <label class="custom-control-label"
                                    for="different-markers-bg"><?php echo qrcdr()->getString('different_markers_colors'); ?></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row collapse" id="collapse-different-markers-bg">
                        <div class="col-sm-6 mt-2">
                            ...
                            <div class="input-group rounded-0">
                                <span class="input-group-text rounded-0 border-0 text-dark"><svg width="1em"
                                        height="1em" viewBox="0 0 14 14" fill="currentColor"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0,0v14h14V0H0z M12,12H2V2h10V12z"></path>
                                    </svg></span>
                                <input type="text" class="qrcolorpicker form-control rounded-0"
                                    value="<?php echo $stringfrontcolor; ?>" name="marker_top_right_outline">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mt-2">
                            ...
                            <div class="input-group rounded-0">
                                <span class="input-group-text rounded-0 border-0 text-dark"><svg width="1em"
                                        height="1em" viewBox="0 0 6 6" fill="currentColor"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <rect width="6" height="6"></rect>
                                    </svg></span>
                                <input type="text" class="qrcolorpicker form-control rounded-0"
                                    value="<?php echo $stringfrontcolor; ?>" name="marker_top_right_center">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mt-2 mb-2">
                            ...
                            <div class="input-group rounded-0">
                                ...
                                <input type="text" class="qrcolorpicker form-control rounded-0"
                                    value="<?php echo $stringfrontcolor; ?>" name="marker_bottom_left_outline">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mt-2 mb-2">
                            ...
                            <div class="input-group rounded-0">
                                ...
                                <input type="text" class="qrcolorpicker form-control rounded-0"
                                    value="<?php echo $stringfrontcolor; ?>" name="marker_bottom_left_center">
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="accordion-item d-grid">
        <button
            class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>"
            type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseWatermark"
            data-target="#collapseWatermark">
    ...
    */
        ...
        ?>
            <div class="col-12 pt-2">
                <div class="logoselecta form-group">
                    <div class="btn-group-toggle" data-toggle="buttons">
                        ...
                        <label class="btn btn-light custom-watermark"><input type="radio" name="optionlogo" value=""
                                class="btn-check">
            ...
            <div class="col-12 mb-2">
                <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label"
                        for="no-logo-bg"><?php echo qrcdr()->getString('no_logo_background'); ?></label>
                </div>
            </div>

            <div class="col-12 qrcdr-slider">
                <input type="range" min="30" max="100" value="100" class="qrcdr-slider-input" name="logo-size">
                <label class="small"><?php echo qrcdr()->getString('logo_size'); ?>: <span
    ...
    <div class="accordion-item d-grid">
        ...
        <button
            class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>"
            type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseFrame"
            data-target="#collapseFrame">
            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 24 24">
                <path
        ...
        <div class="collapse<?php echo $collapsed; ?>" id="collapseFrame" <?php echo $accordion_parent; ?>>
            ...
            <div class="col-12">
                <div class="row">
                    ...
                    <div class="col-12 qrcdr-slider">
                        <input type="range" min="50" max="100" value="100" class="qrcdr-slider-input"
                            name="label-text-size">
                        <label class="small"><?php echo qrcdr()->getString('text_size'); ?>: <span
                                class="qrcdr-slider-value"></span></label>
                    </div>
                </div>
            </div>
            <div class="col-12 mb-2">
                <div class="row collapse" id="collapse-frame-color">
                    <div class="col-sm-6 mt-2">
                        ...
                        <input type="text" class="form-control qrcolorpicker rounded-0"
                            value="<?php echo $stringfrontcolor; ?>" name="framecolor">
                    </div>
                </div>

                <div class="form-group mt-2">
                    <div class="custom-control custom-switch">
                        <input type="checkbox" class="custom-control-input collapse-control" id="frame-color"
                            data-bs-target="#collapse-frame-color" data-target="#collapse-frame-color"
                            name="custom_frame_color">
                        <label class="custom-control-label"
                            for="frame-color"><?php echo qrcdr()->getString('custom_frame_color'); ?></label>
                    </div>
                </div>
            </div>
        </div> <!-- collapse frame -->
    ...
    <div class="accordion-item d-grid">
        <button
            class="mb-2 btn btn-outline-primary btn-lg btn-block text-start text-left<?php echo $rounded_btn_opt; ?>"
            type="button" data-bs-toggle="collapse" data-toggle="collapse" data-bs-target="#collapseOptions"
            data-target="#collapseOptions">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-toggles" fill="currentColor"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
